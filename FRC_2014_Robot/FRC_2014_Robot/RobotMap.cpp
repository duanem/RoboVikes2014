...
DoubleSolenoid* RobotMap::intakeIntakeSolenoid = NULL;
CANJaguar* RobotMap::intakeIntakeRoller = NULL;
...
void RobotMap::init() {
	...
	intakeIntakeSolenoid = new DoubleSolenoid(1, 5);      
	
	
	intakeIntakeRoller = new CANJaguar(8);
