...
void AutoDrive::Execute() {
	...
	driveDistance = Robot::chassis->rightEncoder->GetDistance();
	//goalDistance = Robot::autoPref->GetDouble("GoalDistance", 0);
	//Robot::chassis->robotDrive->Drive(Robot::autoPref->GetDouble("DriveSpeed" , 0), 
	//			   Robot::autoPref->GetDouble("DriveAngle", 0));
